...
(define-fun loop_invariant@5 ((i___int@v (_ BitVec 32)) (s___int@v (_ BitVec 32)) (loop@4@count (_ BitVec 64))) Bool true)
...
(assert (= node_7_ok (=> (= loop@4@count~1 (_ bv0 64)) (and node_5_ok (=> (not (loop_invariant@5 i___int@v~1 s___int@v~1 loop@4@count~1)) node_Err_ok)))))
(assert (= node_5_ok (=> (loop_invariant@5 i___int@v~2 s___int@v~2 loop@4@count~2) (and (=> true node_6_ok) (=> false node_Err_ok)))))
...
(assert (= node_11_ok (and (=> (= (bvsle s___int@v~2 (bvadd s___int@v~2 i___int@v~2)) (bvsle (_ bv0 32) i___int@v~2)) node_10_ok) (=> (not (= (bvsle s___int@v~2 (bvadd s___int@v~2 i___int@v~2)) (bvsle (_ bv0 32) i___int@v~2))) node_Err_ok))))
(assert (= node_10_ok (=> (= s___int@v~3 (bvadd s___int@v~2 i___int@v~2)) node_9_ok)))
(assert (= node_9_ok (and (=> (= (bvsle i___int@v~2 (bvadd i___int@v~2 (_ bv1 32))) (bvsle (_ bv0 32) (_ bv1 32))) node_8_ok) (=> (not (= (bvsle i___int@v~2 (bvadd i___int@v~2 (_ bv1 32))) (bvsle (_ bv0 32) (_ bv1 32)))) node_Err_ok))))
(assert (= node_8_ok (=> (= i___int@v~3 (bvadd i___int@v~2 (_ bv1 32))) node_4_ok)))
(assert (= node_4_ok (=> (= loop@4@count~3 (bvadd loop@4@count~2 (_ bv1 64))) (=> (not (loop_invariant@5 i___int@v~3 s___int@v~3 loop@4@count~3)) node_Err_ok))))
(check-sat)
